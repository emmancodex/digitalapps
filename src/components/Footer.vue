  ...
  <div class="d-flex justify-center">
    ...
    <div class="d-flex flex-column ga-2 pa-4">
      ...
      <section class="navLinks" role="navigation">
        <ul class="d-flex justify-center ga-4">
          <li>
            <a href="https://www.navyfederal.org/about/about.php">About Us</a>
          ...
          <li>
            <a href="https://www.navyfederal.org/privacy/online.php">Privacy</a>
            <p class="spacing" aria-hidden="true">|</p>
          </li>
          <li>
            <a href="https://www.navyfederal.org/security/">Security</a>
            <p class="spacing" aria-hidden="true">|</p>
          </li>
          <li>
      ...
      <section class="copyRight">
        <p>© 2024 Navy Federal Credit Union.</p>
      ...
      <section class="rates2"></section>
      <section class="messageRates"></section>
      <section class="disclosure"></section>
      <section class="webPolicy"></section>
      <section class="reCaptchaPolicies"></section>
    </div>
  </div>
</template>

<script setup>
import Logofooter from "./Logofoote.vue";
</script>
